...
var WordpressGenerator = yeoman.generators.Base.extend({
  init: function() {
    ...
    this.option('debug', {
      desc: 'Debug-mode for localized development of the generator',
      defaults: false,
    });
  ...
  removeDebugFiles: function() {
    if (this.options.debug) {
      return false;
    }

    this.log.info(chalk.red('Removing'), chald.green('debug files...'));
